...
"""
# NOTE: 1=Roll, 2=Pitch, 3=Throttle, 4=Yaw, 6=camera pitch
        SET_POSITION_TARGET_LOCAL_NED  <-- used to set position or velocity of quad http://ardupilot.org/dev/docs/copter-commands-in-guided-mode.html
...
for simulating user input and when implementing certain types of joystick control).
        vehicle.gimbal.rotate(-90, 0, 0) <--  first value is pitch, 0 is horizontal, -90 is down
...
print(" Ch5 (unused)      : %s" % vehicle.channels['5'])
print(" Ch6 (camera pitch): %s" % vehicle.channels['6'])
print(" Ch7 (unused)      : %s" % vehicle.channels['7'])
print(" Ch8 (unused)      : %s" % vehicle.channels['8'])
